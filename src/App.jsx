...
//   if (loading)
//     return (
//       <div className="text-center mt-20 text-gray-600 text-xl font-semibold">
//         در حال بارگذاری آیه...
//       </div>
//     );
...
//   return (
//     <div className="min-h-screen bg-gradient-to-tr from-green-100 via-white to-green-200 flex flex-col items-center justify-center px-4 py-8 font-vazir">
//       <motion.div
//         initial={{ opacity: 0, scale: 0.9, y: 20 }}
//         animate={{ opacity: 1, scale: 1, y: 0 }}
//         transition={{ duration: 0.6 }}
//         className="bg-white shadow-2xl rounded-3xl p-8 w-full max-w-xl text-center space-y-6 border border-green-300 relative"
//       >
//         <h1 className="text-2xl font-bold text-green-700 drop-shadow-sm">
//           ختم شماره {toPersianNumber(khatmCount)}
//         </h1>
...
//           animate={{ opacity: 1, y: 0 }}
//           transition={{ delay: 0.3, duration: 0.6 }}
//           className="text-3xl text-green-900 font-bold leading-loose quran-font"
//         >
//           {ayah.text}
//         </motion.p>
...
//           onClick={handleNext}
//           disabled={!canContinue}
//           className={`mt-4 px-6 py-2 transition duration-200 text-white font-semibold rounded-full ${
//             canContinue
